...
from reagent.gym.types import ActionPreprocessor, TrainerPreprocessor, PostStep
from reagent.replay_memory.circular_replay_buffer import ReplayBuffer
from reagent.training.rl_dataset import RLDataset


def default_post_step(*args, **kwargs):
    pass


def replay_buffer_post_step(
...
def log_data_post_step(dataset: RLDataset, action_preprocessor: ActionPreprocessor, mdp_id: str) -> PostStep:
    sequence_number = 0

...
from reagent.preprocessing.batch_preprocessor import InputColumn
...
def build_action_normalizer(env):
    ...
    if isinstance(action_space, gym.spaces.Discrete):
        ...
        ), f"Box action space with shape {action_space.shape} is not supported."
...
def build_normalizer(env):
    return {
        InputColumn.STATE_FEATURES: build_state_normalizer(env),
        InputColumn.ACTION: build_action_normalizer(env),
    }

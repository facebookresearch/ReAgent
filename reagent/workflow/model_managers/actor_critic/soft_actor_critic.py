...
class SoftActorCritic(ActorCriticBase):
    ...
    def __post_init_post_parse__(self):
        ...
        self.eval_parameters = self.evaluation or EvaluationParameters()
    ...
    def build_trainer(self) -> SACTrainer:
        ...
        self._actor_network = actor_net_builder.build_actor(
            self.get_normalization_data(InputColumn.STATE_FEATURES),
            self.get_normalization_data(InputColumn.ACTION),
        )

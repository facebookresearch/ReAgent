...
class MDNRNNTrainer:
    ...
    def get_loss(
        ...
        (GMMLoss(next_state, GMMPredicted) + MSE(reward, predicted_reward) + BCE(not_terminal, logit_not_terminal)) / (STATE_DIM + 2)
        ...
        :param training_batch: The batch of training data
        :param state_dim: the dimension of states. If provided, use it to normalize gmm loss

...
if importlib.util.find_spec("thriftpy") is not None:
  ...
  thrift_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "thrift/core.thrift")
  thrift = thriftpy.load(thrift_path, module_name="core_thrift") # pylint: disable=all
else:

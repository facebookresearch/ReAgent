...
class TestGridworldTD3(GridworldTestBase):
    ...
    def get_critic_exporter(self, trainer, environment):
        ...
        q2_exporter = None
        if trainer.q2_network:
            q2_exporter = ParametricDQNExporter(
                trainer.q2_network, feature_extractor, output_transformer
            )

        return (
            ParametricDQNExporter(
    ...
    def _test_td3_trainer(self, use_gpu=False, **kwargs):
        ...
        self.evaluate_gridworld(environment, evaluator, trainer, exporter1, use_gpu)

        if exporter2:
            self.evaluate_gridworld(environment, evaluator, trainer, exporter2, use_gpu)
